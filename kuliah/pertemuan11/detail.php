      ...
      <div class="row no-gutters">
        ...
        <div class="col-md-8">
          <div class="card-body">
            ...
            <a href="ubah.php?id=<?= $m['id']; ?>" class="card-link btn-primary btn btn-primary btn-sm">Ubah</a>
            <a href="hapus.php?id=<?= $m['id']; ?>" onclick="return confirm('apakah anda yakin?');" class="card-link btn btn-danger btn-sm">Hapus</a>
